...
void set_member_by_index(DDS_DynamicData &instance, 
                         ...
                         const T & val)
{
  set_memberI_value<DefaultMemberNames, 0>(instance, MemberAccess::BY_ID(index+1), val);
}
...
void set_member_by_name(DDS_DynamicData &instance, 
                        ...
                        const T & val)
{
  set_memberI_value<DefaultMemberNames, 0>(instance, MemberAccess::BY_NAME(name), val);
}
...
struct GetNestedType<Union<TagType, Args...>, Indices<Head, Tail...>>
{
  typedef typename Union<TagType, Args...>::case_tuple_type CaseTuple;
...
struct GetNestedType<Union<TagType, Args...>, Indices<Head>>
{
  typedef typename Union<TagType, Args...>::case_tuple_type CaseTuple;
  typedef typename std::tuple_element<Head, CaseTuple>::type Case;
...
template <class... Args, int Head, int... Tail>
struct GetNestedType<Sparse<Args...>, Indices<Head, Tail...>>
{
...
template <class... Args, int Head>
struct GetNestedType<Sparse<Args...>, Indices<Head>>
{
  typedef typename Sparse<Args...>::raw_tuple_type RawTuple;
