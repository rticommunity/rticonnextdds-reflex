...
namespace reflex {
  ...
  /**
  * Creates a <a href="http://community.rti.com/rti-doc/510/ndds/doc/html/api_cpp/structDDS__TypeCode.html">TypeCode</a>
  ...
  */
  ...
  /**
   * Populates the <a href="http://community.rti.com/rti-doc/510/ndds/doc/html/api_cpp/structDDS__DynamicData.html">
   ...
   */
  template <class T>
  void write_dynamicdata(const T & src, DDS_DynamicData &dest);

  /**
  * Copies data into the underlying a <a href="http://community.rti.com/rti-doc/510/ndds/doc/html/api_cpp/structDDS__DynamicData.html">
  ...
  */
  template <class T>
  void write_dynamicdata(const T & src, AutoDynamicData &dest);
   ...
   */
  template <class T>
  void read_dynamicdata(const DDS_DynamicData & src, T & dest);
  ...
  */
  template <class T>
  void read_dynamicdata(const AutoDynamicData & src, T & dest);
