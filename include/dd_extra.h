...
DllExport void set_memberI_value(DDS_DynamicData & instance,         \
                       const MemberAccess &ma,                       \
	                     const TYPE & val);

#define GET_VALUE_DECL(TYPE)                                         \
DllExport void get_memberI_value(const DDS_DynamicData & instance,   \
                       const MemberAccess &ma,                       \
                       TYPE & val);
...
DllExport void set_seq_length(DDS_DynamicData & seq,
                              size_t size,
                              bool is_string);

DllExport std::string remove_parenthesis(std::string);
